...
function UpperSection() {
    return (
        ...
        <p className="text-white text-center leading-8 text-[1rem] mobile:text-[0.85rem] px-2">
          A simple, open-source tool to help you create a professional CV in no
          time. Free to use, no ads, and no sign-ups—just add your details and
          get started.
        </p>
        <span className="py-2 px-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full mb-4 text-center  mobile:text-[0.85rem] small-mobile:text-[0.6rem]">
          <span className="fa-solid fa-face-smile-beam text-[1rem] mobile:text-[0.85rem] mr-1"></span>{" "}
          Be free to use, to contribute, and to share
        </span>
      </div>
    )
};
