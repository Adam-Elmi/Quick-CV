  ...
  return (
    ...
    <div className="flex w-full justify-between flex-wrap gap-10 tablet:flex-col">
      ...
      <div className="bg-white p-2 flex-1 flex items-center px-4 gap-8 flex-col w-[300px] max-w-full tablet:w-full">
        <p className="text-[1.5em] mobile:text-[1.1rem] small-mobile:text-[0.85rem] text-center text-slate-400 font-bold border-2 border-dotted p-2 mt-3 border-blue-100 rounded-full">
          Create and download a CV in 3 easy steps
        </p>
        <img
          src={teamImage}
          alt="Picture"
          className="max-w-full object-cover tablet:w-full scale-110 px-4 tablet:transform-none tablet:scale-100 tablet:px-0"
        />
      </div>
      {/* Right Section */}
      <StepsComponent />
